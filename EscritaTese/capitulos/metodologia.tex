\chapter{Metodologia} \label{cap:proposta}
    ...
    \noindent de modo que $\hat{x}'_{i,k} \approx \pm 1$ corresponde a $\hat{x}_{i,k} \in \{0,1\}$. Essa restrição é imposta energeticamente através de um potencial de poço duplo \cite{weedbrook2012gaussian}:
