...
\newcounter{codigo}
\renewcommand{\thecodigo}{\arabic{codigo}}
...
\usepackage[labelfont=bf,textfont=normalfont]{subcaption}
...
\include{capitulos/vehicle_routing_problem}
\include{capitulos/quantum_mechanics}
\include{capitulos/optimization}
% \include{capitulos/ferramentas}

% PARTE
\hiddenpart{Metodologia}
