...
A Computação Quântica de Variáveis Contínuas (\textit{Continuous Variables Quantum Computing} - CVQC) processa informação não em bits binários, mas em estados que podem assumir qualquer valor dentro de um intervalo contínuo, como amplitudes e fases de campos eletromagnéticos. Analogamente, enquanto a QC convencional opera como um interruptor de luz --- transitando entre estados discretos com suas superposições ---, a CVQC opera como um dimmer, capaz de ajustar o brilho a qualquer nível dentro de uma faixa contínua.
